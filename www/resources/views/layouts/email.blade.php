                        ...
                        <table width="600" border="0" cellspacing="0" cellpadding="0" align="center"
                            ...
                            <tr>
                                <td align="center" valign="middle"
                                    ...
                                    bgcolor="#ffffff">
                                    <span class="appleFooter" style="color:#aea9c3;">Kyiv, Ukraine</span><br><a
                                        class="original-only" style="color: #5d5386; text-decoration: underline;"
                                        href="http://stage.dronepilot.info/">Отписаться</a><span class="original-only"
                                                                                                 style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span><a
                                        class="original-only" style="color: #5d5386; text-decoration: underline;"
                                        href="http://stage.dronepilot.info/">Контакты</a><span class="original-only"
                                                                                               style="font-family: Arial, sans-serif; font-size: 12px; color: #444444;">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span><a
                                        class="original-only" style="color: #5d5386; text-decoration: underline;"
                                        href="http://stage.dronepilot.info/">Главная</a>
                                </td>
                            </tr>
                        </table>
                    </td>
