...
@section('title', $tag->title ? $tag->title : $tag->name)
@section('description', $tag->description ? $tag->description : 'DronePilot записи по Тегу: ' . $tag->name)
@section('keywords', $tag->keywords ? $tag->keywords : 'DronePilot записи по Тегу: ' . $tag->name)
                    ...
                    <div class="blog-listing">
                        <div class="row">
                            @if(count($result))
                                ...
                                @endforeach
                            @else
                                <p>Нет записей связанных с данным тегом: {{ $tag->name }}</p>
                            @endif
                        </div>
                    </div>
                </div>
