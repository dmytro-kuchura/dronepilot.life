                    ...
                    <div class="about-detail">
                        <div class="row">
                            ...
                            <div class="col-12 mt-30">
                                ...
                                <p>
                                    Меня зовут Димтрий, увлекаюсь аэросъемкой. Увлекаюсь! Я не считаю себя никоим образом
                                    профессиональным оператором дрона. Но фото и видео с дрона я люблю.
                                </p>
                                <p>
                                    В добавок ко всему стал интересоваться о провозке дрона в другие страны для фото.
                                    Именно по тому и решил все сгрупировать в одном месте. В добавок истории из жизни.
                                </p>
                                <p>
